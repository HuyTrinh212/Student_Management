...
import com.example.student_management.first_fragment
...
class ListAdapter internal constructor(context: Context, val noteDB:Student_Database) :RecyclerView.Adapter<ListAdapter.ItemViewHolder>() {
  ...
  fun setNote (notes: List<Student_Entity>) {
    ...
    class ItemViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        val textView1: TextView = view.findViewById(R.id.rs_email)
        val textView2: TextView = view.findViewById(R.id.rs_contact)
        val textView3: TextView = view.findViewById(R.id.rs_adress)
        val imageView1: ImageView = view.findViewById(R.id.imv_edit)
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.textView1.text = currentNote.email
        holder.textView2.text = currentNote.sdt
        holder.textView3.text = currentNote.adress
        ...
        holder.imageView1.setOnClickListener{
            ...
            uiScope.launch {
                ...
                noteDB?.studentDao()?.update(currentNote)
